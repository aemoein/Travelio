  ...
  return (
    <div style={{ flexGrow: 1 }}>
      ...
      <Box style={{ position: 'relative', width: '100vw', height: '33vw', overflow: 'hidden' }}>
        ...
        <Avatar alt="Profile Picture" src={userData.profilePicUrl} sx={{ position: 'absolute', width: '16vw', height: '16vw', top: '75.75%', left: '50%', transform: 'translate(-50%, -50%)', zIndex: 2, border: '5px solid white', }} />
      </Box>
