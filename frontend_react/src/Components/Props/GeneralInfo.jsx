...
const GeneralInfo = ({ language, currency, region }) => {
  return (
    <Box sx={{height: { xs: '150px', sm: '160px', md: '180px', lg: '200px' }, textAlign: 'center', backgroundColor: '#f0f0f0', padding: '20px', borderRadius: '10px', boxShadow: '0px 4px 8px rgba(0, 0, 0, 0.1)'}}>
      <Typography sx={{ fontFamily: "Poppins", fontSize: { xs: '14px', sm: '16px', md: '18px', lg: '20px' }, fontWeight: 700 }}>Local Language</Typography>
